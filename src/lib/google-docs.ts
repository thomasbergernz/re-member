...
function buildContent(applicant: ApplicantInfo, driveFiles: DriveFile[]) {
  ...
  const FR_LABELS: Record<string, string> = {
    agreeMemberServices: "Agrees to actively provide Member Services",
  ...
  const COMPETENCIES = [
    ...
    "Core Subject-Matter Knowledge",
    "Business acumen",
    "Networking & Referrals",
    "Holistic support",
    "Client journey advocacy",
    "Long-Term Planning & Review",
    "Structured Advance Planning",
    "Transition Planning & Support",
    "Practical Assistance",
    "Milestone & Event Planning",
    "Handover & Closing Practices",
    "Transition & Support Awareness",
  ...
  const docCounts = [
    ...
    ["Advance Planning Certification", applicant.docPlanningCertCount, "planning_cert"],
    ["Specialist Online Training", applicant.docSpecialistTrainingCount, "specialist_training"],
    ["Fundamentals of Practice", applicant.docFundamentalsCount, "fundamentals"],
  ...
  const decls = [
    ...
    ["Active Member Services", applicant.declarationMemberServices],
